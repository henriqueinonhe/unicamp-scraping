...
/* harmony import */ var _Models_InstituteEntry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Models/InstituteEntry */ "./src/Models/InstituteEntry.ts");
...
var Database = /** @class */ (function () {
    ...
    Database.storeInstituteEntries = function (entries) {
    ...
    Database.fetchInstituteEntries = function () {
        return __awaiter(this, void 0, void 0, function () {
            var mongoURI, mongoClient, database, collection, instituteEntries;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mongoURI = process.env.DB_URI;
                    ...
                    case 1:
                        _a.sent();
                        database = mongoClient.db("unicamp-docentes");
                        collection = database.collection("model");
                        return [4 /*yield*/, collection.find({}).toArray()];
                    case 2:
                        instituteEntries = (_a.sent()).map(function (entry) { return _Models_InstituteEntry__WEBPACK_IMPORTED_MODULE_1__["InstituteEntry"].deserialize(entry); });
                        //Close Connection
                        return [4 /*yield*/, mongoClient.close()];
                    case 3:
                        //Close Connection
...
/* harmony import */ var _logic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logic */ "./src/logic.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
app.get("/data", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Object(_logic__WEBPACK_IMPORTED_MODULE_2__["fetchInstituteEntries"])()];
            case 1:
                data = _a.sent();
                res.send(data);
                return [2 /*return*/];
...
/*!**********************!*\
  !*** ./src/logic.ts ***!
  \**********************/
/*! exports provided: fetchInstituteEntries */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchInstituteEntries", function() { return fetchInstituteEntries; });
...
function fetchInstituteEntries() {
    return __awaiter(this, void 0, void 0, function () {
        var instituteEntries;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _database__WEBPACK_IMPORTED_MODULE_0__["Database"].fetchInstituteEntries()];
                case 1:
